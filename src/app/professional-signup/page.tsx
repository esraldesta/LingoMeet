        ...
        <div className="max-w-4xl mx-auto">
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="flex items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  currentStep >= step ? 'bg-primary text-primary-foreground' : 'bg-secondary text-secondary-foreground'
                }`}>
                  {step}
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {error && (
                <div className="bg-destructive/80 p-4 rounded-lg flex items-center gap-2">
